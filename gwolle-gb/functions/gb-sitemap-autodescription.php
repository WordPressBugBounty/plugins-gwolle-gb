<?php
/*
 * The SEO Framework Sitemap for Gwolle Guestbook.
 * https://wordpress.org/plugins/autodescription/
 *
 * Available under /sitemap.xml
 */
 ...
 * @since 1.1.0
 */
function gwolle_gb_addon_autodescription_sitemap_v2( $pages ) {
