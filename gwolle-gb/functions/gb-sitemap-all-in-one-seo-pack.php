<?php
/*
 * All in one SEO pack Sitemap for Gwolle Guestbook.
 * https://wordpress.org/plugins/all-in-one-seo-pack/
 *
 * Visible under /sitemap.xml and /addl-sitemap.xml
 * Needs Additional pages enabled in Sitemap settings.
 */
 ...
 * @since 1.1.0
 */
function gwolle_gb_addon_all_in_one_get_sitemap_v2( $pages ) {
